  ...
  _createClass(Toggle, [{
    ...
    value: function render() {
      ...
      return React.createElement("button", _extends({}, props, {
        ...
        className: css(isSplitButton ? styles.dropdownToggleButton : styles.dropdownToggle, isFocused && styles.modifiers.focus, isHovered && styles.modifiers.hover, isActive && styles.modifiers.active, isPlain && styles.modifiers.plain, isDisabled && styles.modifiers.disabled, className),
        type: type || 'button',
