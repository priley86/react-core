...
test('InputGroupText', function () {
  var view = shallow(React.createElement(InputGroupText, {
...
test('InputGroup', function () {
  var view = shallow(React.createElement(InputGroup, {
...
test('add aria-describedby to form-control if one of the non form-controls has id', function () {
  ...
  var view = shallow(React.createElement(InputGroup, null, React.createElement(TextInput, {
    value: "some data",
