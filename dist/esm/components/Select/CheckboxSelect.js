...
import { default as formStyles } from "../../@patternfly/patternfly/components/Form/form.css.js";
...
function (_React$Component) {
  ...
  function CheckboxSelect() {
    ...
    _defineProperty(_assertThisInitialized(_this), "childKeyHandler", function (index, position) {
      keyHandler(index, position, _this.refCollection, _this.props.isGrouped ? _this.refCollection : _this.props.children);
    });
