...
var images = (_images = {}, _defineProperty(_images, BackgroundImageSrc.lg, '/assets/images/pfbg_1200.jpg'), _defineProperty(_images, BackgroundImageSrc.sm, '/assets/images/pfbg_768.jpg'), _defineProperty(_images, BackgroundImageSrc.sm2x, '/assets/images/pfbg_768@2x.jpg'), _defineProperty(_images, BackgroundImageSrc.xs, '/assets/images/pfbg_576.jpg'), _defineProperty(_images, BackgroundImageSrc.xs2x, '/assets/images/pfbg_576@2x.jpg'), _defineProperty(_images, BackgroundImageSrc.filter, '/assets/images/background-filter.svg#image_overlay'), _images);
...
function (_React$Component) {
  ...
  _createClass(SimpleLoginPage, [{
    ...
    value: function render() {
      var helperText = React.createElement(React.Fragment, null, React.createElement(ExclamationCircleIcon, null), "\xA0Invalid login credentials.");
      var socialMediaLoginContent = React.createElement(React.Fragment, null, React.createElement(LoginMainFooterLinksItem, {
        href: "#"
      ...
      var signUpForAccountMessage = React.createElement(LoginMainFooterBandItem, null, "Need an account? ", React.createElement("a", {
        href: "#"
      }, "Sign up."));
      var forgotCredentials = React.createElement(LoginMainFooterBandItem, null, React.createElement("a", {
        href: "#"
      }, "Forgot username or password?"));
      var listItem = React.createElement(React.Fragment, null, React.createElement(ListItem, null, React.createElement(LoginFooterItem, {
        href: "#"
