...
test('renders with PatternFly Core styles', function () {
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_FormHelperText["default"], {
    isError: true,
    isHidden: false
  }));
...
test('LoginFooterItem  with custom node', function () {
  ...
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_FormHelperText["default"], null, _react["default"].createElement(CustomNode, null)));
  expect(view).toMatchSnapshot();
});