  ...
  _createClass(Wizard, [{
    ...
    value: function render() {
      ...
      return isOpen && ReactDOM.createPortal(React.createElement(FocusTrap, {
        ...
        className: (0, _reactStyles.css)(_wizardCss["default"].wizard, isCompactNav && 'pf-m-compact-nav', activeStep.isFinishedStep && 'pf-m-finished', setFullWidth && _wizardCss["default"].modifiers.fullWidth, setFullHeight && _wizardCss["default"].modifiers.fullHeight, className),
        role: "dialog",
        "aria-modal": "true",
