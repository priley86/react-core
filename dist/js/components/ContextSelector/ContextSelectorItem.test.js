...
test('Renders ContextSelectorItem', function () {
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_ContextSelectorItem["default"], {
    sendRef: jest.fn(),
    index: "0"
  }, "My Project"));
...
test('Verify onClick is called ', function () {
  var mockfn = jest.fn();
  var view = (0, _enzyme.mount)(_react["default"].createElement(_ContextSelectorItem["default"], {
    isHovered: true,
    onClick: mockfn,
    sendRef: jest.fn(),
    index: "0"
