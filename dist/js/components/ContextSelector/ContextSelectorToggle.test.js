...
test('Renders ContextSelectorToggle', function () {
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_ContextSelectorToggle["default"], {
    id: "toggle-id"
  }));
...
test('Verify onToggle is called ', function () {
  ...
  var view = (0, _enzyme.mount)(_react["default"].createElement(_ContextSelectorToggle["default"], {
