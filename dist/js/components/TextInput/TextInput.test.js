...
test('input passes value and event to onChange handler', function () {
  ...
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_TextInput["default"], _extends({}, props, {
...
test('disabled text input', function () {
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_TextInput["default"], {
    isDisabled: true,
...
test('should throw console error when no aria-label, id or aria-labelledby is given', function () {
  ...
  (0, _enzyme.shallow)(_react["default"].createElement(_TextInput["default"], props));
...
test('should not throw console error when id is given but no aria-label or aria-labelledby', function () {
  ...
  (0, _enzyme.shallow)(_react["default"].createElement(_TextInput["default"], _extends({}, props, {
    id: "5"
  })));
