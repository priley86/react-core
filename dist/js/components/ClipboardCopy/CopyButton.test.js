...
test('copy button render', function () {
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_CopyButton["default"], props, "Copy Me"));
  expect(view).toMatchSnapshot();
});
test('copy button onClick', function () {
  var onclick = jest.fn();
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_CopyButton["default"], _extends({}, props, {
    onClick: onclick
  }), "Copy to Clipboard"));
