...
test('toggle button render', function () {
  ...
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_ToggleButton["default"], _extends({}, props, {
    "aria-label": desc
  })));
...
test('toggle button is on expanded mode', function () {
  ...
  view = (0, _enzyme.shallow)(_react["default"].createElement(_ToggleButton["default"], _extends({}, props, {
    isExpanded: false
  })));
