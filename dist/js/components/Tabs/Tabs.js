...
exports["default"] = exports.TabsVariant = void 0;
...
var propTypes = {
  ...
  variant: _propTypes["default"].oneOf(Object.values(TabsVariant)),
  ...
  _createClass(InternalTabs, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, !isSecondary && React.createElement("button", {
        ...
        }, React.createElement(_Tab["default"], _extends({}, child.props, {
...
var InternalTabContainer = function InternalTabContainer(_ref4) {
  ...
  return React.createElement(React.Fragment, null, children.map(function (child, index) {
    return !child.props.children ? null : React.createElement(_TabContent["default"], {
      key: index,
      activeKey: activeKey,
      child: child,
