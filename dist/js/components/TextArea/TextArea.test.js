...
test('textarea input passes value and event to onChange handler', function () {
  ...
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_TextArea["default"], _extends({}, props, {
...
test('should throw console error when no aria-label or id is given', function () {
  ...
  (0, _enzyme.shallow)(_react["default"].createElement(_TextArea["default"], props));
...
test('should not throw console error when id is given but no aria-label', function () {
  ...
  (0, _enzyme.shallow)(_react["default"].createElement(_TextArea["default"], _extends({}, props, {
    id: "5"
  })));
