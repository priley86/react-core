...
test('InputGroupText', function () {
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_InputGroupText["default"], {
...
test('InputGroup', function () {
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_InputGroup["default"], {
...
test('add aria-describedby to form-control if one of the non form-controls has id', function () {
  ...
  var view = (0, _enzyme.shallow)(_react["default"].createElement(_InputGroup["default"], null, _react["default"].createElement(_TextInput.TextInput, {
    value: "some data",
