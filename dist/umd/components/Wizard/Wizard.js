...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "react-dom", "exenv", "../../helpers/constants", "@patternfly/react-styles", "../../@patternfly/patternfly/components/Wizard/wizard.css.js", "../Backdrop", "../../layouts/Bullseye", "./WizardHeader", "./WizardFooter", "./WizardToggle", "./WizardNav", "./WizardNavItem", "./WizardContext", 'focus-trap-react'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("react-dom"), require("exenv"), require("../../helpers/constants"), require("@patternfly/react-styles"), require("../../@patternfly/patternfly/components/Wizard/wizard.css.js"), require("../Backdrop"), require("../../layouts/Bullseye"), require("./WizardHeader"), require("./WizardFooter"), require("./WizardToggle"), require("./WizardNav"), require("./WizardNavItem"), require("./WizardContext"), require('focus-trap-react'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.reactDom, global.exenv, global.constants, global.reactStyles, global.wizardCss, global.Backdrop, global.Bullseye, global.WizardHeader, global.WizardFooter, global.WizardToggle, global.WizardNav, global.WizardNavItem, global.WizardContext, global.focusTrapReact);
    global.undefined = mod.exports;
  }
})(void 0, function (exports, _propTypes, _react, _reactDom, _exenv, _constants, _reactStyles, _wizardCss, _Backdrop, _Bullseye, _WizardHeader, _WizardFooter, _WizardToggle, _WizardNav, _WizardNavItem, _WizardContext, FocusTrap) {
  "use strict";
    ...
    _createClass(Wizard, [{
      ...
      value: function render() {
        ...
        return isOpen && ReactDOM.createPortal(React.createElement(FocusTrap, {
          ...
          className: (0, _reactStyles.css)(_wizardCss2["default"].wizard, isCompactNav && 'pf-m-compact-nav', activeStep.isFinishedStep && 'pf-m-finished', setFullWidth && _wizardCss2["default"].modifiers.fullWidth, setFullHeight && _wizardCss2["default"].modifiers.fullHeight, className),
          role: "dialog",
          "aria-modal": "true",
        ...
        }, footer || React.createElement(_WizardFooter.WizardFooterInternal, {
          onNext: this.onNext,
          onBack: this.onBack,
          onClose: onClose,
          isValid: isValid,
