...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["react", "enzyme", "@patternfly/react-core", "./util", "./constants"], factory);
  } else if (typeof exports !== "undefined") {
    factory(require("react"), require("enzyme"), require("@patternfly/react-core"), require("./util"), require("./constants"));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.react, global.enzyme, global.reactCore, global.util, global.constants);
    global.undefined = mod.exports;
  }
})(void 0, function (_react, _enzyme, _reactCore, _util, _constants) {
  "use strict";
  ...
  describe('keyHandler works on ApplicationLauncher', function () {
    ...
    var dropdownItems = [_react2["default"].createElement(_reactCore.DropdownItem, {
      key: "link",
      id: "first"
    }, "Link"), _react2["default"].createElement(_reactCore.DropdownItem, {
      key: "action",
      id: "second",
      component: "button"
    ...
    var view = (0, _enzyme.mount)(_react2["default"].createElement(_reactCore.ApplicationLauncher, {
  ...
  describe('keyHandler works on Dropdown', function () {
    ...
    var view = (0, _enzyme.mount)(_react2["default"].createElement(_reactCore.Dropdown, {
      dropdownItems: dropdownItems,
      isOpen: true,
